...
import { Play, Square, Edit3, RefreshCcw, Camera, Settings, ShieldAlert, Zap, Cpu, Volume2, VolumeX, Smartphone, Monitor } from 'lucide-react';
  ...
  return (
    <main className="min-h-screen bg-white text-slate-800 flex flex-col p-4 md:p-6 font-sans max-w-[700px] mx-auto border-x border-slate-100 shadow-sm">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-red-50/30 border border-red-100/50 rounded-2xl p-6 shadow-sm">
          <h3 className="text-xs font-black uppercase text-red-600 tracking-widest flex items-center gap-2 mb-3">
            <ShieldAlert className="w-3 h-3" /> Safety Protocol
          </h3>
          <ol className="text-[10px] text-slate-500 space-y-2 leading-relaxed list-decimal list-inside">
            <li>Define your <span className="text-red-600 font-bold">Red Zone</span> by clicking corners on the video.</li>
            <li>Press <span className="text-[#55799a] font-bold">Start Monitor</span> to activate AI surveillance.</li>
            <li>Alerts trigger immediately if <span className="text-red-600 font-bold underline decoration-2 underline-offset-2">Any Body Part</span> enters the zone.</li>
          </ol>
        </div>
      </div>
